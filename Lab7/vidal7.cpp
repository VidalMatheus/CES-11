...
void inicializaGrafo (struct grafo *gr);							// inicializa a matriz adjacência com todos os custos zero, até que sejam inseridas aresta
...
int main(){
	...
	inicializaGrafo(&gr);						// inicializa a matriz adjacência com todos os custos zero, até que sejam inseridas arestas
...
// os valores chave são, na verdade, os pesos que ligam o vértice corrente ao vértice vizinho
...
void algPrim(struct grafo gr, FILE *out)
{
	int *parent,	 								// vetor para guardar o MST  
    	   *key,   									// valores chave usados para escolher o nó com aresta de mínimo custo; os valores chave são, na verdade, os pesos que ligam o vértice corrente ao vértice vizinho 
